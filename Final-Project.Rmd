...
output:
  ...
  runtime: shiny
  resource_files:
    QED_DJI_calibration_Coursera_course_4.html
---
...
```{r results = 'asis'}
# shiny::includeHTML('QED_DJI_calibration_Coursera_course_4.html')

shiny::shinyAppDir(
  system.file(paste0(getwd(), '/QED_DJI_calibration_Coursera_course_4.html')),
  options = list(
