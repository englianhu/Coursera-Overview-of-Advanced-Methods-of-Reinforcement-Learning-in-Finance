...
pkgs <- c('devtools', 'knitr', 'kableExtra', 'tint', 'furrr', 
          ...
          'zoo', 'forecast', 'tibbletime', 'fable', 'fabletools', 
          'xml2', 'rjson', 'RJSONIO', 'jsonlite', 'tdplyr', 
          'microbenchmark', 'echarts4r', 'Rdym', 'rvest', 
          'rmarkdown')
...
if(!file.exists('./data/QED_DJI_calibration_Coursera_course_4.Rmd')) {
  ## https://rstudio-pubs-static.s3.amazonaws.com/31702_9c22e3d1a0c44968a4a1f9656f1800ab.html
  ## rmarkdown:::convert_ipynb('https://rlcquuio.labs.coursera.org/notebooks/QED_DJI_calibration_Coursera_course_4.ipynb')
  rmarkdown:::convert_ipynb('./data/QED_DJI_calibration_Coursera_course_4.ipynb')
  }
